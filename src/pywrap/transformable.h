...
static inline void pywrap_transformable(U&& cls) 
{
	...
	.def("move", (RetCls(transformable<Cls,RetCls>::*)(const vector3&))&transformable<Cls,RetCls>::move, py::arg("v"), ungil())
	.def("move", (RetCls(transformable<Cls,RetCls>::*)(const point3&))&transformable<Cls,RetCls>::move, py::arg("p"), ungil())
	...
	.def("mov", (RetCls(transformable<Cls,RetCls>::*)(const vector3&))&transformable<Cls,RetCls>::move, py::arg("v"), ungil())
	.def("mov", (RetCls(transformable<Cls,RetCls>::*)(const point3&))&transformable<Cls,RetCls>::move, py::arg("p"), ungil())
