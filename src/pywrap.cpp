...
//TRANS
	...
	.def("__call__", (point3(transformation::*)(const point3&)const)&transformation::operator())
...
//GRAPHIC
	...
	.def("pan", &view::pan)
	.def("zoom", &view::zoom)
	.def("set_eye", &view::set_eye)
	.def("eye", &view::eye)
	.def("set_center", &view::set_center)
	.def("center", &view::center)
	.def("set_orthogonal", &view::set_orthogonal)
