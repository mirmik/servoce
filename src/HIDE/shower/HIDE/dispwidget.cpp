...
const Handle_AIS_InteractiveContext& future::disp::DisplayWidget::getContext() const {
    return m_context;    
}

void future::disp::DisplayWidget::showEvent(QShowEvent* e) {
    QWidget::showEvent(e);
    //init();
...
void future::disp::DisplayWidget::paintEvent(QPaintEvent* e) {
    Q_UNUSED(e);
...
void future::disp::DisplayWidget::autoscale() {
    m_view->FitAll (0.5, false);
}

void future::disp::DisplayWidget::orient1() {
    orient = 1;
    m_view->ResetViewOrientation();
    autoscale();
}

void future::disp::DisplayWidget::orient2() {
    orient = 2;
    m_view->ResetViewOrientation();
    autoscale();
}

void future::disp::DisplayWidget::resizeEvent(QResizeEvent* e) {
    Q_UNUSED(e);
...
void future::disp::DisplayWidget::init() {
...
void future::disp::DisplayWidget::onMouseWheel( const int theFlags, const int theDelta, const QPoint thePoint )
{
    Q_UNUSED(theFlags);
...
void future::disp::DisplayWidget::onLButtonDown( const int theFlags, const QPoint thePoint ) {
    Q_UNUSED(theFlags);
    m_view->StartRotation(thePoint.x(), thePoint.y(), 1);
    temporary1 = thePoint;
}

void future::disp::DisplayWidget::onMButtonDown( const int theFlags, const QPoint thePoint ) {
    Q_UNUSED(theFlags);
    //m_view->StartRotation(thePoint.x(), thePoint.y());
    temporary1 = thePoint;
}

void future::disp::DisplayWidget::onRButtonDown( const int theFlags, const QPoint thePoint ) {
    Q_UNUSED(theFlags);
    temporary1 = thePoint;
}

void future::disp::DisplayWidget::onLButtonUp( const int theFlags, const QPoint thePoint ) {
}

void future::disp::DisplayWidget::onMButtonUp( const int theFlags, const QPoint thePoint ) {
}

void future::disp::DisplayWidget::onRButtonUp( const int theFlags, const QPoint thePoint ) {
}

void future::disp::DisplayWidget::onMouseMove( const int theFlags, const QPoint thePoint ) {
