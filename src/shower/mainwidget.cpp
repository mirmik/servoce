...
future::disp::MainWidget::MainWidget(QWidget* parent) : QMainWindow(parent) {
...
void future::disp::MainWidget::createActions() {
...
void future::disp::MainWidget::createMenus() {
...
void future::disp::MainWidget::createToolbars() {

}

void future::disp::MainWidget::about() {
...
void future::disp::MainWidget::export_stl() {
...
void future::disp::MainWidget::screenshot() {
    bool ok;
...
void future::disp::MainWidget::orient1() {
    display->orient1();
}

void future::disp::MainWidget::orient2() {
    display->orient2();
}

/*void future::disp::MainWidget::makeBox() {
...
void future::disp::MainWidget::makeCone()
{
    gp_Ax2 anAxis;
...
void future::disp::MainWidget::makeSphere()
{
    gp_Ax2 anAxis;
